...
// Not Functional -- reference to the DOM
// add our markup from HTML file to the page
const root = document.getElementById('root')

// Not Functional -- doesn't return a value
// update the state by editing values
const updateStore = (state, newState) => {
    // Implementing ImmutableJS -- merge map collections
...
// create content -- return the layout in strings of HTML and call functions for extra layout
const App = (state) => {
...
const renderImages = (state) => {
    ...
    return Array.from(base.photos).map(item =>
        `<div class="wrapper">
